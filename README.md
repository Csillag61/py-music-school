...
Basic `CRUD` functionality is available via API endpoints:

- `/musicians/` for listing and creating musicians
- `/musicians/<id>/` for retrieving, updating, and deleting musicians

The `is_adult` property is included in all GET responses as required.
